                    ...
                    <div class="header">
                        <h2>
                            ...
                            <p class="header-dropdown">
                                <a href="{{ url('admin/adminstudent') }}" class="btn bg-indigo waves-effect">Ir al listado de
                                    alumnos</a>
                            </p>
                        </h2>
                    </div>
                    {!! Form::model($student, ['method' => 'PATCH','route' => ['adminstudent.update', $student->id]]) !!}
                    {{ csrf_field() }}
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="total_note"
                                               value="{{ $student->total_note }}" disabled />
                                    </div>
                                </div>
