                    ...
                    <div class="header">
                        <h2>
                            ...
                            <p class="header-dropdown">
                                <a href="{{ url('teachers') }}" class="btn bg-indigo waves-effect">Ir al listado de docentes</a>
                            </p>
                        </h2>
                    </div>
                    {!! Form::open(['method' => 'POST','route' => ['teachers.store'],'style'=>'display:inline']) !!} 
                    {{ csrf_field() }} 
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="space" value="{{ old('space') }}" placeholder="Espacio" required />
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="phone" value="{{ old('phone') }}" placeholder="Teléfono" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" min="1" max="9" class="form-control" value="{{ old('email') }}" name="email" placeholder="e-mail" required />
                                    </div>
                                </div>
