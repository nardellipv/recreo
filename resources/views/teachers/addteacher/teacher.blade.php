                    ...
                    <div class="header">
                        <h2>
                            ...
                            <p class="header-dropdown">
                                <a href="{{ url('teachers') }}" class="btn bg-indigo waves-effect">Ir al listado de
                                    docentes</a>
                            </p>
                        </h2>
                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="space" value="{{ old('space') }}"
                                               placeholder="Espacio Curricular" required/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="email" min="1" max="9" class="form-control"
                                               value="{{ old('email') }}" name="email" placeholder="e-mail" required/>
                                    </div>
                                </div>
                                <div class="form-group" required>
                                    ...
                                    <input name="level" type="radio" id="level3" value="3" class="radio-col-purple"/>
                                    <label for="level3">Ambos niveles</label>
                                </div>
                                <div class="form-group" required>
