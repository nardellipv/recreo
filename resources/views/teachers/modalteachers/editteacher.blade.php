                ...
                <div class="modal-body ">
                    ...
                    <ul class="dashboard-stat-list ">
                            ...
                            <li>
                                DNI
                                <span class="pull-right">
                                <input type="text" class="form-control" name="dni" value="{{ $teacher->dni }}" required  />
                            </span>
                            </li>
                            <li>
                                Espacio
                                <span class="pull-right">
                                <input type="text" class="form-control" name="space" value="{{ $teacher->space }}" required  />
                            </span>
                            </li>
                            <li>
                                Teléfono
                            ...
                            <li>
                                Nivel
                                <span class="pull-right">
                                    <input type="number" min="1" max="2" class="form-control" name="level" value="{{ $teacher->level }}" required />                                        
                                </span>
                            </li>
                            <li>
